...
CREATE INDEX IF NOT EXISTS idx_device_mount_points_device_uuid ON device_mount_points(device_uuid);
CREATE INDEX IF NOT EXISTS idx_device_mount_points_system_id ON device_mount_points(system_id);
